...
const base = (p: P) => ({ viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round" as const, strokeLinejoin: "round" as const, width: 16, height: 16, ...p });
...
export function MediumIcon({ code, ...p }: { code: string } & P) {
  return code === "instagram" ? <IconInstagram {...p} /> : <IconWeb {...p} />;
}
