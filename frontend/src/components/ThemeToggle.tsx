...
/**
 * 한 칸짜리 전환 단추. 지금 화면이 어두우면 해, 밝으면 달을 보여 주고 누르면 반대로
 * 바꾼다. "기기 설정"인 채여도 지금 실제로 보이는 판을 기준으로 뒤집는다.
 *
 * 2026-09-08 헤더에서 뺐다(사용자 지시). 지금은 어디서도 쓰지 않는다 — 화면 밝기는
 * 사람 아이콘 패널과 오른쪽 "내 설정" 상자의 세 칸(ThemeSegments)에서만 고른다.
 * 한 칸으로 되돌릴 자리가 생길 수 있어 코드는 남겨 둔다.
 */
